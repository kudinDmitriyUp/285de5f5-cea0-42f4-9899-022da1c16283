...
export const metadata: Metadata = {
  title: "CryptoVault - Premium Crypto Trading Platform",
  description: "Secure, fast, and institutional-grade cryptocurrency trading platform with military-grade encryption, 24/7 support, and professional tools for serious traders.",
  keywords: "crypto trading, bitcoin, ethereum, trading platform, cryptocurrency exchange, digital assets",
  openGraph: {
    title: "CryptoVault - Professional Crypto Trading",
    description: "Join thousands of traders on the most advanced crypto platform with institutional-grade security",
  ...
  twitter: {
    ...
    title: "CryptoVault - Premium Crypto Trading Platform",
    description: "Secure, professional cryptocurrency trading platform for serious traders"
  },
  robots: {
    index: true,
    follow: true
